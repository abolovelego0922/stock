...
export default function App() {
 ...
 const [performanceList, setPerformanceList] = useLocalStorage(
  ...
  return (
    <div style={{ padding: '15px', fontFamily: 'sans-serif', backgroundColor: '#111827', color: '#fff', minHeight: '100vh', maxWidth: '400px', width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
